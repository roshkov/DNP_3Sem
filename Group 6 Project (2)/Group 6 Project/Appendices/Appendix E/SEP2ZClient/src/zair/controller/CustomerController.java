...
public class CustomerController
{
   ...
   private void loadCustomer(Customer customer)
   {
      ...
      {
         tickets[i] = customer.getTickets()[i].getFlight().getId() + "<" + customer.getTickets()[i].getTicketID() 
               + "<" + customer.getTickets()[i].getFlight().getOrigin().getLocation() 
               + "<" + customer.getTickets()[i].getFlight().getDestination().getLocation() 
               + "<" + customer.getTickets()[i].getFlight().getDateDeparture()
               + " - " + customer.getTickets()[i].getFlight().getDateArrival() + "<" 
               + customer.getTickets()[i].getFlight().getTimeDeparture()
